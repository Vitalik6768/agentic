-- CreateEnum
CREATE TYPE "CredentialType" AS ENUM ('OPENAI', 'GEMINI');

-- CreateEnum
CREATE TYPE "NodeType" AS ENUM ('INITIAL', 'MANUAL_TRIGGER', 'HTTP_REQUEST', 'GOOGLE_FORM_TRIGGER', 'OPENAI', 'GEMINI', 'DISCORD', 'SLACK');
